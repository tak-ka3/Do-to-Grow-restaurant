class PokemonsController < ApplicationController
  ...
  private
    def restaurant_api
      ...
      url = "https://webservice.recruit.co.jp/hotpepper/gourmet/v1/?key=#{api_key}&large_area=#{current_user.prefecture}&order=4&format=json"
      uri = URI.parse(url)
      ...
      raise "Error" unless @shops.present?

      @shop = @shops[random_id]
    end
